...
int sensor_k_probe(struct platform_device *pdev)
{
    ...
    || defined(CONFIG_MACH_GOYAVE3G_SEA) || defined(CONFIG_MACH_GOYAVEWIFI_SEA_XTC) || defined(CONFIG_MACH_VIVALTO3MVEML3G_SEA)
...
#if defined (CONFIG_MACH_CORE3_W) || defined(CONFIG_MACH_J13G) || defined (CONFIG_MACH_GRANDNEOVE3G)\
    || defined (CONFIG_MACH_VIVALTO5MVE3G) || defined(CONFIG_MACH_VIVALTO3MVE3G_LTN) || defined(CONFIG_MACH_VIVALTO3MVEML3G)
...
static ssize_t Front_Cam_Type_Store(struct device *dev, struct device_attribute *attr, const char *buf, size_t size)
{
	...
	|| defined(CONFIG_MACH_J13G) || defined(CONFIG_MACH_GOYAVE3G_SWA) || defined(CONFIG_MACH_GTEL3G) || defined(CONFIG_MACH_GTELWIFI)
